...
export const MOCK_STORE_PRODUCTS: Product[] = [
  ...
  {
    id: 'prod-fit-08',
    name: 'Conjunto Treino Tech Anti-Suor Dri-FIT',
    description: 'Conjunto de camiseta + bermuda de alta compressão e ventilação estratégica para treinos intensos de academia.',
    price: 199,
    ...
    tags: ['Academia & Fit', 'Roupas de Academia', 'Dri-FIT'],
    inStock: true,
    storeName: 'Deco Sports',
    cashbackReward: 9.95,
  },
